...
CREATE TABLE IF NOT EXISTS `allergen` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='过敏源分类表' AUTO_INCREMENT=23 ;

--
-- 转存表中的数据 `allergen`
--

INSERT INTO `allergen` (`id`, `did`, `name`, `level`) VALUES
(0, '', '全部过敏源', ''),
(9, '0', '营养制剂', ''),
(11, '9', '配方粉', ''),
(12, '0', '药食两用食物及其它', ''),
...
CREATE TABLE IF NOT EXISTS `disease` (
  ...
  `level` varchar(20) NOT NULL COMMENT '分类级别',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='病例分类表' AUTO_INCREMENT=26 ;

--
-- 转存表中的数据 `disease`
--

INSERT INTO `disease` (`id`, `did`, `name`, `level`) VALUES
(0, '', '全部病例', ''),
(9, '0', '特殊人群', ''),
(10, '9', '增肌减脂', ''),
(11, '9', '更年期', ''),
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='会员表' AUTO_INCREMENT=8 ;

--
-- 转存表中的数据 `member`
--

INSERT INTO `member` (`id`, `cardid`, `name`, `sex`, `age`, `idnum`, `birthday`, `tel`, `zhiye`, `edu`, `jdtime`, `province`, `city`, `area`, `addr`, `mbs`, `jws`, `jzs`, `gms`, `gmsy`, `yys`, `yylb`, `ypmc`, `xys`, `xysj`, `xypl`, `yjs`, `yjlb`, `yjl`, `smqk`, `smsc`, `ydcs`, `ydxs`, `ydfz`, `dlxm`, `ysxg`, `jcrs`, `huny`, `sg`, `tz`, `bmi`, `sgopj`, `yw`, `tw`, `ytb`, `ytpj`, `ssy`, `szy`, `xypj`, `gysz`, `zdgc`, `sgpj`, `gdb`, `ddb`, `dbpj`, `kfxt`, `chxt`, `xtpj`, `xns`, `xnspj`, `xhdb`, `xhdbpj`, `ts`, `tspj`, `gmd`, `gmdpj`, `tys`, `addtime`) VALUES
(1, '2', '啊', '男', 58, '612424199505030010', '1540396800', '18329556944', '农民', '中专', 1540483200, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1538977757),
(2, '', '', '男', 0, '', '', '', '无', '无', 0, '0', '0', '0', '0', NULL, NULL, NULL, '0', NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1539162214),
(3, '', '啦啦啦', '男', 0, '', '', '', '无', '无', 0, '0', '0', '0', '0', '', '', '', '0', '', '0', '降压药', '', '0', '', '', '0', '请选择', '', '0', '', '', '', '', '', '甜食', '', '已婚', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, 1541649278),
(4, '2', '测试', '男', 24, '612424199505030010', '1542902400', '18329556944', '白领', '博士', 1542297600, '北京市', '北京市市辖区', '东城区', '阿萨德', '老年人,素食人群', '素食人群,孕晚期', '老年人,孕晚期', '1', '哺乳期', '1', '降脂药', '阿莫西林', '1', '12', '20', '0', '', '', '1', '7', '10', '10', '', '素食人群', '荤食', '2', '已婚', '170', '65', '22.49', '正常', '80', '90', '0.89', '正常', '120', '75', '正常血压', '1', '3', '正常', '1', '2', '非正常', '5', '6', '正常血糖', '300', '正常', '5', '正常值', '6', '正常', '-2', '骨量低', NULL, 1542353983),
(5, '', '测试', '男', 24, '612424199505030010', NULL, '18329556944', '白领', '博士', NULL, '北京市', '北京市市辖区', '东城区', '暗示的时代', NULL, NULL, NULL, '0', NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, '', '测试', '男', 24, '612424199505030010', NULL, '18329556944', '白领', '博士', NULL, '北京市', '北京市市辖区', '东城区', '朝阳区', NULL, NULL, NULL, '0', NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, '', '测试', '男', 24, '612424199505030010', NULL, '18329556944', '白领', '博士', NULL, '北京市', '北京市市辖区', '东城区', '请问', NULL, NULL, NULL, '0', NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `member_card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='会员卡' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `member_card`
--

INSERT INTO `member_card` (`id`, `xuliehao`, `bianhao`, `zhikaren`, `time`) VALUES
(2, 'B1ACD121', 'R0C000032707', '100', '1542006518'),
(3, 'B1ACD121', '123123123', '100', '1542012673');
...
CREATE TABLE IF NOT EXISTS `motion` (
  ...
  `level` varchar(20) NOT NULL COMMENT '分类级别',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='过敏源分类表' AUTO_INCREMENT=28 ;

--
-- 转存表中的数据 `motion`
--

INSERT INTO `motion` (`id`, `did`, `name`, `level`) VALUES
(0, '', '全部运动', ''),
(11, '0', '跳绳', ''),
(12, '0', '跑步', ''),
(13, '0', '舞蹈', ''),
...
(24, '13', '中速', ''),
(25, '13', '慢速', ''),
(26, '14', '16千米每小时-19千米每小时', ''),
(27, '14', '12千米每小时-16千米每小时', '');
